...
class AjouterEtudiantComponent extends Component {
    ...
    ajouterEtudiant = (event) => {
        ...
        EtudiantService.ajouterEtudiant(etudiant).then(res =>{
                ...
                <div className='container'>
                    <div className='row p-2'>
                        <div className='card col-md-6 offset-md-3 offset-md-3'>
                            <h3 className='text-center'>Ajouter étudiant</h3>
                            <div className='card-body'>
                                <form>
                                    ...
                                    <div className='form-group p-1'>
                                        <button className='btn btn-success' onClick={this.ajouterEtudiant}>Ajouter</button>
...
export default AjouterEtudiantComponent;